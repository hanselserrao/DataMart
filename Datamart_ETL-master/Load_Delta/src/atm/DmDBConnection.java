...
public class DmDBConnection {
    ...
    public Connection getDBConnection() {
    	...
    	else 
    	{
			...
			if( propertiesFile.isEmpty() != true)
			{
				//check file exists
				...
				if(file.isFile())
				{
			    	try {
				        ...
				        setDBName(properties.getProperty("dmDBName"));
				        String str;
				...
				else
				{
					...
					DMLogger.log("USAGE: DBProd_import.jar -n_file=<properties file with absolutepath>");
					System.exit(0);
				}
			}
			else
			{
				DMLogger.log("ERROR: Properties file is missing..Exiting");
				System.exit(0);
			}
